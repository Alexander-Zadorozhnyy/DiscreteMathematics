...
print(f"Раскодированное сообщение --> {decoding_adaptive_Haffman_code(encoded_message, alphabet)}")
print(
    f"Сравним нашу строку и полученную после декодирования"
    f" --> {my_string == decoding_adaptive_Haffman_code(encoded_message, alphabet)}\n")
