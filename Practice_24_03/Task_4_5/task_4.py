...
def print_all_results_of_test(start_string):
    ...
    print(f"4.1) Закодировать сообщение по Шенону:")
    print(coding(my_string, 1, Shannon_codes) + "\n")
    print(f"4.1.1) Закодировать сообщение по Шенону-Фано:")
    print(coding(my_string, 1, ShannonFano_codes) + "\n")
    print(f"4.1.2) Закодировать сообщение по Хаффману:")
    print(coding(my_string, 1, Haffman_codes) + "\n")

    print(f"4.2) Закодировать сообщение по двойному Шенону:")
    print(coding(my_string, 2, Shannon_double_codes) + "\n")
    print(f"4.2.1) Закодировать сообщение по двойному Шенону-Фано:")
    print(coding(my_string, 2, ShannonFano_double_codes) + "\n")
    print(f"4.2.2) Закодировать сообщение по двойному Хаффману:")
    print(coding(my_string, 2, Haffman_double_codes) + "\n")
    ...
    print(
        f"5.1.1) Определить энтропию двойных кодов --> "
        f"{get_total_entropy_of_codes(list(all_double_symbols_probability.values()))}\n")
    print(f"5.1) Определить среднюю длину и избыточность для всех двойных кодов:")
    print(
        f"По Шеннону --> "
        f"средняя длина: "
        f"{get_average_lenght(list(all_double_symbols_probability.values()), list(Shannon_double_codes.values()))}, "
        f"избыточность: "
        f"{get_message_redundancy(list(all_double_symbols_probability.values()), list(Shannon_double_codes.values()))}")
    print(
        f"По Шеннону-Фано --> "
        f"средняя длина: "
        f"{get_average_lenght(list(all_double_symbols_probability.values()), list(ShannonFano_double_codes.values()))}, "
        f"избыточность: "
        f"{get_message_redundancy(list(all_double_symbols_probability.values()), list(ShannonFano_double_codes.values()))}")
    print(
        f"По Хаффману --> "
        f"средняя длина: "
        f"{get_average_lenght(list(all_double_symbols_probability.values()), list(Haffman_double_codes.values()))}, "
        f"избыточность: "
        f"{get_message_redundancy(list(all_double_symbols_probability.values()), list(Haffman_double_codes.values()))}\n")
    ...
    print(
        ...
        f" --> {start_string == decoded_message}\n")
